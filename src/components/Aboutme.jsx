...
function Aboutme() {
  return (
    <div id="about" className="min-h-screen w-full flex flex-col items-center bg-gray-200 py-12 px-6 text-gray-800">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start">
        ...
        <div className="w-full md:w-1/2 md:pl-8">
          <h2 className="text-3xl font-semibold mb-4">Hi, Im Jessica</h2>
          <p className="text-lg mb-6">
            Im a certified health coach with over 10 years of experience in helping people achieve their health and wellness goals. My approach is holistic, focusing on both physical and mental well-being.
          </p>
          ...
          <p className="text-lg mb-6">
            Ready to start your journey to better health? Lets work together to achieve your goals!
          </p>
