...
function Navbar() {
  ...
  return (
    ...
    <div className="bg-emerald-400 py-3 justify-between px-6 flex sticky top-0 w-full text-black">
        ...
        <ul className="text-lg md:flex justify-center items-center gap-5 hidden">
            ...
            <li className=" bg-gray-900 rounded-lg hover:bg-gray-800 duration-300 text-white cursor-pointer p-3">BOOK NOW</li>
        </ul>
